# It will keep only those left side entities which will be matched with the right side
import pandas as pd

League01 = {
    "Name": ["Babar Azam", "Saim Ayub", "Sahibzada Farhan", "Salman Agha", None, "Irfan Khan Niazi", 
             "Shadab Khan", "Shaheen Afridi", "Haris Rauf", "Muhammad Hussnain", "Sufyan Muqeem"],
