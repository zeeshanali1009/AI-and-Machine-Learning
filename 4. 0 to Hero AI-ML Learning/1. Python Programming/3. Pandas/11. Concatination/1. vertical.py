# concatination is the combination of two or more dataframes it is of two types 
# vertical (cocatinates rows) and horizontal (concatinates columns)
import pandas as pd
...
df_concatinated = pd.concat([df1, df2], axis=0, ignore_index=True)             # axis = 1 means the horizonatal concatination
print(df_concatinated)